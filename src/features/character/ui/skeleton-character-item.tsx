...
import Loader from '../../../shared/ui/icons/loader/loader';
...
export function CharacterItemSkeleton() {
  ...
  return (
    <div
      data-testid="character-item-skeleton"
      className="p-4 w-full flex flex-col items-center animate-pulse"
    >
      ...
      <div className="text-center">
        <p
          data-testid="character-item-skeleton-name"
          className={
        ...
        <p
          data-testid="character-item-skeleton-gender"
          className={
